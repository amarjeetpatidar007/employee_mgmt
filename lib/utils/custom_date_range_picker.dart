    ...
    setState(() {
      switch (option) {
        case 'Today':
          ...
          break;
        case 'Next Monday':
          selectedDate = DateTime.now().add(Duration(days: (8 - DateTime
              .now()
              .weekday) % 7));
          break;
        case 'Next Tuesday':
          selectedDate = DateTime.now().add(Duration(days: (9 - DateTime
              .now()
              .weekday) % 7));
          break;
        case 'After 1 week':
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final maxWidth = isMobile ? constraints.maxWidth * 0.95 : 400.0;
...
//                 children: [
//                   GridView.count(
//                     crossAxisCount: (maxWidth < 400) ? 2 : 4,
//                     shrinkWrap: true,
//                     mainAxisSpacing: 10,
//                     crossAxisSpacing: 10,
//                     childAspectRatio: 3,
